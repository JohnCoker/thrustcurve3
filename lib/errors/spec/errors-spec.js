...
describe("errors", function() {
  ...
  describe("throw", function() {
    it("error", function() {
      expect(function() {
        errors.throw(errors.DATA_FILE_EMPTY, 'no data for {1}', 'stuff');
      }).toThrowError('error occurred');
    });
    it("validation", function() {
      expect(function() {
        errors.throw(errors.DATA_FILE_EMPTY, 'no data for {1}');
      }).toThrowError('invalid message parameter: {1}');
    });
  });
  describe("ignore", function() {
    it("error", function() {
      let error = errors.ignore;
      expect(function() {
        error(errors.DATA_FILE_EMPTY, 'no data for {1}', 'stuff');
      }).not.toThrow();
