...
describe('helpers', function() {
  ...
  describe("formatMassFrac", function() {
    it("simple", function() {
      expect(helpers.formatMassFrac(0.6)).toBe('0.60');
      expect(helpers.formatMassFrac(0.9)).toBe('0.90');
    });
    it("rounding", function() {
      expect(helpers.formatMassFrac(0.751)).toBe('0.75');
      expect(helpers.formatMassFrac(0.899)).toBe('0.90');
    });
    it("undefined", function() {
      expect(helpers.formatMassFrac(undefined)).toBe('—');
    });
    it("NaN", function() {
      expect(helpers.formatMassFrac(0/0)).toBe('—');
      expect(helpers.formatMassFrac(1/0)).toBe('—');
    });
    it("zero", function() {
      expect(helpers.formatMassFrac(0)).toBe('—');
    });
  });
