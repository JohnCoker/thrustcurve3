...
describe('helpers', function() {
  ...
  describe("formatLength", function() {
    ...
    it("default", function() {
      expect(helpers.formatLength(1.23456789)).toBe('1,235mm');
    });
    it("in/lb", function() {
    ...
    it("large", function() {
      units.setDefaultsPref(units.defaults.get('in/lb'));
      expect(helpers.formatLength(123.456789)).toBe('4,860.50in');
    });
    it("undefined", function() {
  ...
  describe("formatMass", function() {
    it("default", function() {
      prefs.clear();
      expect(helpers.formatMass(1.23456789)).toBe('1,235g');
    });
    it("in/lb", function() {
      units.setDefaultsPref(units.defaults.get('in/lb'));
  ...
  describe("formatDurationFine", function() {
    it("default", function() {
      prefs.clear();
      expect(helpers.formatDurationFine(12.3456789)).toBe('12.3s');
      expect(helpers.formatDurationFine(0.3456789)).toBe('0.35s');
      expect(helpers.formatDurationFine(0.03456789)).toBe('0.035s');
      expect(helpers.formatDurationFine(0.003456789)).toBe('0.0035s');
    });
    it("in/lb", function() {
      units.setDefaultsPref(units.defaults.get('in/lb'));
      expect(helpers.formatDurationFine(12.3456789)).toBe('12.3s');
