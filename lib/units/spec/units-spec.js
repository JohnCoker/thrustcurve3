  ...
  describe("formatPrefFromMKS", function() {
    ...
    describe("MKS", function() {
      ...
      it("length large", function() {
        expect(formatPrefFromMKS(12345.67, 'length')).toBe('12346m');
      });
      it("length large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'length', true)).toBe('12345.670m');
      });
      it("mass", function() {
        expect(formatPrefFromMKS(1.0, 'mass')).toBe('1.0kg');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(12345.67, 'mass')).toBe('12346kg');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'mass', true)).toBe('12345.670kg');
      });
      it("force", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
      it("force large", function() {
        expect(formatPrefFromMKS(12345.67, 'force')).toBe('12346N');
      });
      it("force large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'force', true)).toBe('12345.7N');
      });
      it("velocity", function() {
        expect(formatPrefFromMKS(1.0, 'velocity')).toBe('1.0m/s');
      });
      it("velocity large", function() {
        expect(formatPrefFromMKS(12345.67, 'velocity')).toBe('12346m/s');
      });
      it("velocity large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'velocity', true)).toBe('12345.7m/s');
      });
      it("acceleration", function() {
        expect(formatPrefFromMKS(1.0, 'acceleration')).toBe('1.0m/s²');
      });
      it("acceleration large", function() {
        expect(formatPrefFromMKS(12345.67, 'acceleration')).toBe('12346m/s²');
      });
      it("acceleration large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'acceleration', true)).toBe('12345.7m/s²');
      });
      it("altitude", function() {
        expect(formatPrefFromMKS(1.0, 'altitude')).toBe('1m');
      });
      it("altitude large", function() {
        expect(formatPrefFromMKS(12345.67, 'altitude')).toBe('12346m');
      });
      it("altitude large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'altitude', true)).toBe('12346m');
      });
    });
    ...
    describe("CGS", function() {
      ...
      it("length large", function() {
        expect(formatPrefFromMKS(12345.67, 'length')).toBe('1234567cm');
      });
      it("length large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'length', true)).toBe('1234567.0cm');
      });
      it("mass", function() {
        expect(formatPrefFromMKS(1.0, 'mass')).toBe('1000g');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(12345.67, 'mass')).toBe('12345670g');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'mass', true)).toBe('12345670g');
      });
      it("force", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
    ...
    describe("in/lb", function() {
      ...
      it("length large", function() {
        expect(formatPrefFromMKS(254.0, 'length')).toBe('10000in');
      });
      it("length large fixed", function() {
        expect(formatPrefFromMKS(254.0, 'length', true)).toBe('10000.00in');
      });
      it("mass small", function() {
        expect(formatPrefFromMKS(0.453592, 'mass')).toBe('1.0lb');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(4535.92, 'mass')).toBe('10000lb');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(4535.92, 'mass', true)).toBe('10000.00lb');
      });
      it("force small", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
      it("force large", function() {
        expect(formatPrefFromMKS(1000.0, 'force')).toBe('1000N');
      });
      it("force large fixed", function() {
        expect(formatPrefFromMKS(1000.0, 'force', true)).toBe('1000.0N');
      });
      it("velocity small", function() {
        expect(formatPrefFromMKS(0.3048, 'velocity')).toBe('1.0ft/s');
      });
      it("velocity large", function() {
        expect(formatPrefFromMKS(3048.0, 'velocity')).toBe('10000ft/s');
      });
      it("velocity large fixed", function() {
        expect(formatPrefFromMKS(3048.0, 'velocity', true)).toBe('10000.0ft/s');
      });
      it("acceleration small", function() {
        expect(formatPrefFromMKS(0.3048, 'acceleration')).toBe('1.0ft/s²');
      });
      it("acceleration large", function() {
        expect(formatPrefFromMKS(3048.0, 'acceleration')).toBe('10000ft/s²');
      });
      it("acceleration large fixed", function() {
        expect(formatPrefFromMKS(3048.0, 'acceleration', true)).toBe('10000.0ft/s²');
      });
      it("altitude small", function() {
        expect(formatPrefFromMKS(0.3048, 'altitude')).toBe('1ft');
      });
      it("altitude large", function() {
        expect(formatPrefFromMKS(3048.0, 'altitude')).toBe('10000ft');
      });
      it("altitude large fixed", function() {
        expect(formatPrefFromMKS(3048.0, 'altitude', true)).toBe('10000ft');
      });
    });
    ...
    describe("in/oz", function() {
      ...
      it("mass large", function() {
        expect(formatPrefFromMKS(283.495, 'mass')).toBe('10000oz');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(283.495, 'mass', true)).toBe('10000.0oz');
      });
      it("force small", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
