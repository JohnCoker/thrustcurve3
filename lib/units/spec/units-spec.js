  ...
  describe("formatPrefFromMKS", function() {
    ...
    describe("MKS", function() {
      ...
      it("length small", function() {
        expect(formatPrefFromMKS(1, 'length')).toBe('1.0m');
      });
      it("length small fixed", function() {
        expect(formatPrefFromMKS(1, 'length', true)).toBe('1.000m');
      });
      it("length large", function() {
        expect(formatPrefFromMKS(12345.67, 'length')).toBe('12,346m');
      });
      it("length large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'length', true)).toBe('12,345.670m');
      });
      it("mass", function() {
        expect(formatPrefFromMKS(1.0, 'mass')).toBe('1.0kg');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(12345.67, 'mass')).toBe('12,346kg');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'mass', true)).toBe('12,345.670kg');
      });
      it("force", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
      it("force large", function() {
        expect(formatPrefFromMKS(12345.67, 'force')).toBe('12,346N');
      });
      it("force large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'force', true)).toBe('12,345.7N');
      });
      it("velocity", function() {
        expect(formatPrefFromMKS(1.0, 'velocity')).toBe('1.0m/s');
      });
      it("velocity large", function() {
        expect(formatPrefFromMKS(12345.67, 'velocity')).toBe('12,346m/s');
      });
      it("velocity large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'velocity', true)).toBe('12,345.7m/s');
      });
      it("acceleration", function() {
        expect(formatPrefFromMKS(1.0, 'acceleration')).toBe('1.0m/s²');
      });
      it("acceleration large", function() {
        expect(formatPrefFromMKS(12345.67, 'acceleration')).toBe('12,346m/s²');
      });
      it("acceleration large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'acceleration', true)).toBe('12,345.7m/s²');
      });
      it("altitude", function() {
        expect(formatPrefFromMKS(1.0, 'altitude')).toBe('1m');
      });
      it("altitude large", function() {
        expect(formatPrefFromMKS(12345.67, 'altitude')).toBe('12,346m');
      });
      it("altitude large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'altitude', true)).toBe('12,346m');
      });
    });
    ...
    describe("CGS", function() {
      ...
      it("length small", function() {
        expect(formatPrefFromMKS(1, 'length')).toBe('100.0cm');
      });
      it("length small fixed", function() {
        expect(formatPrefFromMKS(1, 'length', true)).toBe('100.0cm');
      });
      it("length large", function() {
        expect(formatPrefFromMKS(12345.67, 'length')).toBe('1,234,567cm');
      });
      it("length large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'length', true)).toBe('1,234,567.0cm');
      });
      it("mass", function() {
        expect(formatPrefFromMKS(1.0, 'mass')).toBe('1,000g');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(12345.67, 'mass')).toBe('12,345,670g');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(12345.67, 'mass', true)).toBe('12,345,670g');
      });
      it("force", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
    ...
    describe("in/lb", function() {
      ...
      it("length small", function() {
        expect(formatPrefFromMKS(0.0254, 'length')).toBe('1.0in');
      });
      it("length large", function() {
        expect(formatPrefFromMKS(254.0, 'length')).toBe('10,000in');
      });
      it("length large fixed", function() {
        expect(formatPrefFromMKS(254.0, 'length', true)).toBe('10,000.00in');
      });
      it("mass small", function() {
        expect(formatPrefFromMKS(0.453592, 'mass')).toBe('1.0lb');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(4535.92, 'mass')).toBe('10,000lb');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(4535.92, 'mass', true)).toBe('10,000.00lb');
      });
      it("force small", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
      it("force large", function() {
        expect(formatPrefFromMKS(1000.0, 'force')).toBe('1,000N');
      });
      it("force large fixed", function() {
        expect(formatPrefFromMKS(1000.0, 'force', true)).toBe('1,000.0N');
      });
      it("velocity small", function() {
        expect(formatPrefFromMKS(0.3048, 'velocity')).toBe('1.0ft/s');
      });
      it("velocity large", function() {
        expect(formatPrefFromMKS(3048.0, 'velocity')).toBe('10,000ft/s');
      });
      it("velocity large fixed", function() {
        expect(formatPrefFromMKS(3048.0, 'velocity', true)).toBe('10,000.0ft/s');
      });
      it("acceleration small", function() {
        expect(formatPrefFromMKS(0.3048, 'acceleration')).toBe('1.0ft/s²');
      });
      it("acceleration large", function() {
        expect(formatPrefFromMKS(3048.0, 'acceleration')).toBe('10,000ft/s²');
      });
      it("acceleration large fixed", function() {
        expect(formatPrefFromMKS(3048.0, 'acceleration', true)).toBe('10,000.0ft/s²');
      });
      it("altitude small", function() {
        expect(formatPrefFromMKS(0.3048, 'altitude')).toBe('1ft');
      });
      it("altitude large", function() {
        expect(formatPrefFromMKS(3048.0, 'altitude')).toBe('10,000ft');
      });
      it("altitude large fixed", function() {
        expect(formatPrefFromMKS(3048.0, 'altitude', true)).toBe('10,000ft');
      });
    });
    ...
    describe("in/oz", function() {
      ...
      it("mass small", function() {
        expect(formatPrefFromMKS(0.0283495, 'mass')).toBe('1.0oz');
      });
      it("mass large", function() {
        expect(formatPrefFromMKS(283.495, 'mass')).toBe('10,000oz');
      });
      it("mass large fixed", function() {
        expect(formatPrefFromMKS(283.495, 'mass', true)).toBe('10,000.0oz');
      });
      it("force small", function() {
        expect(formatPrefFromMKS(1.0, 'force')).toBe('1.0N');
      });
  ...
  describe("formatUnit", function() {
    ...
    describe("MKS", function() {
      it("length m", function() {
        expect(formatUnit(1.0, 'length', 'm')).toBe('1.0m');
      });
      it("length m fixed", function() {
        expect(formatUnit(1.0, 'length', 'm', true)).toBe('1.000m');
      });
      it("mass kg", function() {
        expect(formatUnit(1.0, 'mass', 'kg')).toBe('1.0kg');
      });
      it("mass kg fixed", function() {
        expect(formatUnit(1.0, 'mass', 'kg', true)).toBe('1.000kg');
      });
    });
    describe("in/lb", function() {
      it("length in", function() {
        expect(formatUnit(39.0, 'length', 'in')).toBe('39.0in');
      });
      it("length in fixed", function() {
        expect(formatUnit(39.0, 'length', 'in', true)).toBe('39.00in');
      });
      it("mass lb", function() {
        expect(formatUnit(2.2, 'mass', 'lb')).toBe('2.2lb');
      });
      it("mass lb fixed", function() {
        expect(formatUnit(2.2, 'mass', 'lb', true)).toBe('2.20lb');
      });
    });
    describe("invalid", function() {
      it("NaN", function() {
